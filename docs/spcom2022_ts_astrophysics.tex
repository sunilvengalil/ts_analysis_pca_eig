...
\begin{figure*}
   \centering
   \subfigure[]{\includegraphics[width=0.28\textwidth]{images/sac_ascf_kappa_e1_vs_e2_m_2_tau_50.jpg}}
   \subfigure[]{\includegraphics[width=0.28\textwidth]{images/sac_ascf_mu_e1_vs_e2_m_4_tau_80.jpg}}
   \subfigure[]{\includegraphics[width=0.28\textwidth]{images/sac_ascf_rho_e1_vs_e2_m_8_tau_20.jpg}}
   \caption{Plot of E1 vs E2 (top two right singular vectors) of data matrix for  representatives from non-stochastic time series of \textit{GRS 1915 + 105}. The series are $\kappa$, $\mu$ and $\rho$ from left to right.}
   \label{svd_e1e2_nonstochastic}
\end{figure*}
...
\begin{figure*}
   \centering
   \subfigure[]{\includegraphics[width=0.28\textwidth]{images/sac_ascf_phi_e1_vs_e2_m_2_tau_20.jpg}}
   \subfigure[]{\includegraphics[width=0.28\textwidth]{images/sac_ascf_kai_e1_vs_e2_m_2_tau_20.jpg}}
   \subfigure[]{\includegraphics[width=0.28\textwidth]{images/sac_ascf_gamma_e1_vs_e2_m_2_tau_20.jpg}}
